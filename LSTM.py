...
class LSTMModel(nn.Module):
    def __init__(self, size = 256, embedding_dim = 100, num_layers = 2, dropout = 0.2, number_of_output_classes = 2, L = 30, prediction_method = 'sum'):
    ...
    def train(self, gen_batched, epochs, lr):
        ...
        for epoch in range(epochs):
            ...
            for (input_batch, true_classes) in zip(text, tags):
                ...
                loss = criterion(self.postprocess_predictions(y_pred), true_classes)
                tot_loss += loss
